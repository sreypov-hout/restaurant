...
const PopularDishes = ({ dishes }) => {
  ...
  return (
    <div className="container max-w-7xl mx-auto px-6 py-12 relative">
      {/* Success Popup - Same as in KhmerFood */}
      {showPopup && (
      ...
      <div className="mt-4">
        <h2 className="text-2xl font-bold text-black mb-8">Most Popular</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {dishes.map((dish) => {
            ...
            return (
              <div
                key={dish.id}
                className="bg-black/10 backdrop-blur-xl rounded-2xl p-4 hover:bg-black/15 transition-colors"
              >
                <div className="relative">
                  <div className="w-50 h-50 bg-black rounded-full flex items-center justify-center text-4xl mb-4 mx-auto shadow-lg">
                    <img
                      src={dish.image}
                      alt={dish.name}
